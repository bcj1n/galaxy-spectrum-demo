...
if os.path.exists("/home/adminuser/venv/lib/python3.12/site-packages/bagpipes"):
    install_dir = "/home/adminuser/venv/lib/python3.12/site-packages/bagpipes"
else:
    install_dir = "/usr/local/anaconda/envs/sed/lib/python3.12/site-packages/bagpipes"
